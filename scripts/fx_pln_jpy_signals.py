...
def _load_tuned_kalman_params(asset_symbol: str, cache_path: str = "scripts/quant/cache/kalman_q_cache.json") -> Optional[Dict]:
    """
...
def main() -> None:
    ...
    if failures:
        ...
        # Save failed assets to scripts/quant/cache/failed/ for later purging
        try:
