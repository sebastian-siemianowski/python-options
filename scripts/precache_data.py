...
Usage:
    ...
    python scripts/precache_data.py --workers 2 --batch-size 16
    python scripts/precache_data.py --years 5  # fetch 5 years of history
    python scripts/precache_data.py --assets AAPL,MSFT,GOOGL  # specific assets only
"""
