...
try:
    from options.data_cache import load_price_history
except Exception:
...
DEFAULT_CSV_PATH = 'src/data/russell/russell5000_tickers.csv'  # Use 5000 ticker universe
...
# Simple meta cache for Ticker.info with TTL under src/data/options/meta/
