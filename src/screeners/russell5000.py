#!/usr/bin/env python3
"""
Builds a Russell 5000 tickers CSV at src/data/russell/russell5000_tickers.csv by scraping
...
Usage:
  make russell5000
  # or directly:
  python src/screeners/russell5000.py [--out src/data/russell/russell5000_tickers.csv]
"""
import argparse
import os
import sys
...
DEFAULT_OUT = "src/data/russell/russell5000_tickers.csv"
DATA_DIR = "data"
...
Examples:
  ...
  python src/screeners/russell5000.py     # Same as above
  python src/screeners/russell5000.py --min_size 3000  # Build smaller universe
        """
    )
