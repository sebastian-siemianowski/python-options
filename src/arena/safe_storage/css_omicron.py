"""
Safe Storage: css_omicron
Arena Results: Final: 68.7, BIC: -50427, CRPS: 0.0185, Hyv: 4508, PIT: PASS, CSS: 0.71, FEC: 0.86, +13.8 vs STD
...
class CssOmicronModel:
    """
    CSS Omicron: Best-performing Generation 26 CSS-focused model.
    
    Achieves excellent BIC (-50427) with strong CSS (0.71) and FEC (0.86).
