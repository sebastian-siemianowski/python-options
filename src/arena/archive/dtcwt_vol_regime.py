"""
DTCWT Vol Regime Model
Arena Score: 61.44 | BIC: -24799 | CRPS: 0.0205 | Hyv: -2392.3 | PIT: 83% | CSS: 0.66 | FEC: 0.80 | vs STD: +4.6%

DTCWT with explicit volatility regime conditioning - reduces aggression in high-vol, increases in low-vol.
"""
...
class DTCWTVolRegimeModel:
    ...
    def _filter(self, returns: np.ndarray, vol: np.ndarray, params: Dict) -> Tuple[np.ndarray, np.ndarray, float, np.ndarray]:
        ...
        # Regime multipliers: [low_vol, normal, high_vol]
