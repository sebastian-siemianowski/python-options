...
Usage:
    python src/purge_failed.py          # Purge cache files for failed assets
    python src/purge_failed.py --list   # List failed assets without purging
    python src/purge_failed.py --clear  # Clear the failed assets list (keep cache)
    python src/purge_failed.py --all    # Purge cache AND clear the list
"""
