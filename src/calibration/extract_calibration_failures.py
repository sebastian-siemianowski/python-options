...
Usage:
    python src/extract_calibration_failures.py
    python src/extract_calibration_failures.py --severity critical
    python src/extract_calibration_failures.py --min-pit 0.01
...
DEFAULT_CALIBRATION_FILE = os.path.join(
    ...
    'data', 'calibration', 'calibration_failures.json'
)
