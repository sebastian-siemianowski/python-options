...
Usage:
    python src/clean_cache.py          # Clean all cached price files
    python src/clean_cache.py --quiet  # Clean without verbose output
"""
...
from src.data_utils import clean_price_cache, PRICE_CACHE_DIR_PATH
