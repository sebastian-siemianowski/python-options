...
DEFAULT_CACHE_PATH = os.path.join("src", "quant", "cache", "fx_plnjpy.json")
...
def _load_tuned_kalman_params(asset_symbol: str, cache_path: str = "src/quant/cache/tune") -> Optional[Dict]:
    """
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--cache-json", type=str, default=DEFAULT_CACHE_PATH, help="Path to auto-write cache JSON (default src/quant/cache/fx_plnjpy.json)")
...
def main() -> None:
    ...
    if failures:
        ...
        # Save failed assets to src/quant/cache/failed/ for later purging
        try:
