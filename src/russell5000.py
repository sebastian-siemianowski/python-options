...
Usage:
  make russell5000
  # or directly:
  python src/russell5000.py [--out data/universes/russell5000_tickers.csv]
"""
import argparse
import os
import sys
...
Examples:
  ...
  python src/russell5000.py     # Same as above
  python src/russell5000.py --min_size 3000  # Build smaller universe
        """
    )
