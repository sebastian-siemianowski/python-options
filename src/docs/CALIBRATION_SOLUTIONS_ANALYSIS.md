...
#### 1. `src/calibration/adaptive_nu_refinement.py`
...
2. `src/calibration/phi_t_mixture_k2.py` - Relax BIC threshold
3. `src/calibration/adaptive_nu_refinement.py` - Add refinement candidates for ν=4,6,8
4. `src/signals_ux.py` - Enhanced diagnostics display
5. `src/tuning/tune_ux.py` - Add `--force-escalation` flag
