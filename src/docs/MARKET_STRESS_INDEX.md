...
python src/options/options.py --bt_market_stress_filter true

# Enable with custom threshold (more restrictive)
python src/options/options.py --bt_market_stress_filter true --bt_market_stress_threshold 0.3

# Enable with less restrictive threshold
python src/options/options.py --bt_market_stress_filter true --bt_market_stress_threshold 0.5
```
