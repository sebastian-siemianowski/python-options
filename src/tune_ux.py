...
Usage:
    python src/tune_ux.py --dry-run --max-assets 5
    python src/tune_ux.py --force
    python src/tune_ux.py
"""
...
Examples:
  ...
  %(prog)s --debug                          # Enable debug output
    ...
    parser.add_argument('--cache-json', type=str, default='src/cache/tune',
